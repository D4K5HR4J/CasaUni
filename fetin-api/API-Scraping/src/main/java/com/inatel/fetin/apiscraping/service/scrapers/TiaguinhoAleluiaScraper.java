...
@Service
public class TiaguinhoAleluiaScraper implements Scraper {

    @Override
    public List<Imovel> scrape() {
        List<Imovel> imoveis = new ArrayList<>();
        String url = "https://www.tiaguinhoaleluia.com.br/imovel/locacao/todos/santa-rita-do-sapucai";
        ...
        try {
            ...
            for (Element box : propertyBoxes) {
                ...
                Element imgElement = box.selectFirst(".col.imovelcard__img");
                String id = "https://www.tiaguinhoaleluia.com.br"+imgElement.attr("href");
                ...
                imoveis.add(new Imovel(id, titulo, preco, imagem, "Tiaguinho Aleluia"));
            }

        } catch (IOException e) {
            System.err.println("Erro ao fazer scraping Tiaguinho Aleluia: " + e.getMessage());
        }
